...
void DetectionOutputLayer<Dtype>::Forward_gpu(
  ...
  string det_odm_loc = "/workspace/run/test/Det_odm_loc.txt";
  string det_odm_conf = "/workspace/run/test/Det_odm_conf.txt";
  string det_arm_prior= "/workspace/run/test/Det_arm_prior.txt";
  string det_arm_conf = "/workspace/run/test/Det_arm_conf.txt";
  string det_arm_loc  = "/workspace/run/test/Det_arm_loc.txt";
